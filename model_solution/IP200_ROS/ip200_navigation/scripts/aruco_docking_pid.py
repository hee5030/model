...
class DockingController:
    def __init__(self):
        ...
        self.target_y = 490  # target y position (image bottom)
        ...
        self.linear_velocity = rospy.get_param('~linear_velocity', 0.1)  # 0.1m/s
        self.camera_height = rospy.get_param('~camera_height', 0.2)  # 0.4m
    ...
    def rotate_to_find_aruco(self, rotate_velocity):
        ...
        vel_msg.angular.z = rotate_velocity
    ...
    def go_straight_to_docking(self, distance=0.3, threshold=0.05):
    ...
    def main(self):
        self.move_to_docking_station(self)
        # self.go_straight_to_docking(distance=0.03, threshold=0.01)
        # rospy.sleep(2.0)
        self.control_loop()
        rospy.loginfo('loop finished')
        rospy.sleep(7.0)
        self.go_straight_to_docking()
        rospy.sleep(0.5)
